...
class DIDAgentSimple {
    ...
    public function render_agent_shortcode($atts) {
        ...
        if (empty($atts['agent_id'])) {
            return '<div style="padding: 20px; background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; color: #dc3545;">Error: Agent ID is required. Use [did_agent_simple agent_id="your_agent_id"]</div>';
        }
    ...
    public function admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1>D-ID Agent Simple Settings</h1>
